...
This project is indexed by GitNexus as **trading-bot** (4656 symbols, 4854 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/trading-bot/context` | Codebase overview, check index freshness |
| `gitnexus://repo/trading-bot/clusters` | All functional areas |
| `gitnexus://repo/trading-bot/processes` | All execution flows |
| `gitnexus://repo/trading-bot/process/{name}` | Step-by-step execution trace |
